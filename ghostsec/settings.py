...
INSTALLED_APPS = [
    ...
    'ghostsec.ctf.CTFConfig',
    'ghostsec.forum.ForumConfig',
    'ghostsec.learning.LearningConfig',
    'ghostsec.learning_environments.LearningEnvironmentsConfig',
    'ghostsec.main.MainConfig',
    'ghostsec.marketplace.MarketplaceConfig',
    'ghostsec.news.NewsConfig',
    'ghostsec.oauth.OAuthConfig',
]
